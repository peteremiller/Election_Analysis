...
#filepath = os.path.join("../Analysis/election_results.csv")
filepath = os.path.join("Resources/election_results.csv")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        if (county_votes > max_county_votes):
            max_county_votes = county_votes
